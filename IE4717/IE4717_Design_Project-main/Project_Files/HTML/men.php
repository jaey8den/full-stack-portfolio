		...
		<div id="navbar" class="flex max-width fixed">
			<div class="flex min-width">
				<ul>
					...
					<!--<li>
						This one is to help u show the count of the item index. Can delete if understood
						<span>
							<?php
                                //echo "Tee count is" . $_SESSION['cart'][1];
								//echo "Pants count is" . $_SESSION['cart'][2];
								//echo "Shoe count is" . $_SESSION['cart'][3];
                            ?>
						</span>
					</li>-->
				</ul>
